...
<script type="text/javascript">
 ...
 function doValidate(){
	...
	document.getElementById('hiddentr8').innerHTML = newHTML;
		...
		if(passwordfield1.value.length==0 && passwordreenterfield.value.length==0)
		{
			document.getElementById("hiddentr9").style.display = '';
		...
		var alphabetNumericExpression = /^[a-zA-Z0-9]+$/;
			if(passwordfield1.value.match(alphabetNumericExpression) && passwordfield1.value.length==7){
				document.getElementById("hiddentr9").style.display = '';
				document.getElementById("hiddentr10").style.display = '';
			}
			...
			if(passwordfield1.value==passwordreenterfield.value){
			document.getElementById("hiddentr10").style.display = '';
...
<table class="tabledata">
    ...
    <tr>
      ...
      <td width="172"><input type="text" name="city" id="city" class="inputfield" /></td>
      <td width="156" id="hiddentr4">&nbsp;</td>
    </tr>
    <tr>
      <td class="fieldheading">Country</td>
      <td width="172"><input type="text" name="country" id="country"class="inputfield" /></td>
    ...
    <tr>
      ...
      <td id="hiddentr8">This will be your user ID for login</td>
    </tr>
    <tr>
      <td class="fieldheading">Please enter a password</td>
      <td><input type="password" name="customerpassword" id="customerpassword"/></td>
      <td id="hiddentr9">Password length should be 7 characters and contain only letters and numbers.</td>
    </tr>
    <tr>
      <td class="fieldheading">Re-enter password</td>
      <td><input type="password" name="reenterpassword" id="reenterpassword"/></td>
      <td id="hiddentr10">&nbsp;</td>
    </tr>
...
?>
  ...
  <p>
    <input type="submit" name="submit" value="Save" class="buttonstyle"  onClick="return doValidate()"> 
